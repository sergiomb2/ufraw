...
const wb_data wb_preset[] = {
  ...
  { "FUJIFILM", "FinePix X100", "2500K", 0,	{ 1, 1.6503, 5.1858, 0 } },
  { "FUJIFILM", "FinePix X100", "2550K", 0,	{ 1, 1.5729, 4.7917, 0 } },
  { "FUJIFILM", "FinePix X100", "2650K", 0,	{ 1, 1.4313, 4.1090, 0 } },
  { "FUJIFILM", "FinePix X100", "2700K", 0,	{ 1, 1.3790, 3.8447, 0 } },
  { "FUJIFILM", "FinePix X100", "2800K", 0,	{ 1, 1.2797, 3.3814, 0 } },
  { "FUJIFILM", "FinePix X100", "2850K", 0,	{ 1, 1.2377, 3.1844, 0 } },
  { "FUJIFILM", "FinePix X100", "2950K", 0,	{ 1, 1.1660, 2.8571, 0 } },
  { "FUJIFILM", "FinePix X100", "3000K", 0,	{ 1, 1.1353, 2.7180, 0 } },
  { "FUJIFILM", "FinePix X100", "3100K", 0,	{ 1, 1.0824, 2.4731, 0 } },
  { "FUJIFILM", "FinePix X100", "3200K", 0,	{ 1, 1.0342, 2.2671, 0 } },
  { "FUJIFILM", "FinePix X100", "3300K", 0,	{ 1.0066, 1, 2.1060, 0 } },
  { "FUJIFILM", "FinePix X100", "3400K", 0,	{ 1.0430, 1, 2.0265, 0 } },
  { "FUJIFILM", "FinePix X100", "3600K", 0,	{ 1.1159, 1, 1.8907, 0 } },
  { "FUJIFILM", "FinePix X100", "3700K", 0,	{ 1.1457, 1, 1.8311, 0 } },
  { "FUJIFILM", "FinePix X100", "3800K", 0,	{ 1.1755, 1, 1.7781, 0 } },
  { "FUJIFILM", "FinePix X100", "4000K", 0,	{ 1.2351, 1, 1.6821, 0 } },
  { "FUJIFILM", "FinePix X100", "4200K", 0,	{ 1.2848, 1, 1.5993, 0 } },
  { "FUJIFILM", "FinePix X100", "4300K", 0,	{ 1.3079, 1, 1.5662, 0 } },
  { "FUJIFILM", "FinePix X100", "4500K", 0,	{ 1.3543, 1, 1.5000, 0 } },
  { "FUJIFILM", "FinePix X100", "4800K", 0,	{ 1.4172, 1, 1.4205, 0 } },
  { "FUJIFILM", "FinePix X100", "5000K", 0,	{ 1.4536, 1, 1.3742, 0 } },
  { "FUJIFILM", "FinePix X100", "5300K", 0,	{ 1.5033, 1, 1.3179, 0 } },
  { "FUJIFILM", "FinePix X100", "5600K", 0,	{ 1.5530, 1, 1.2715, 0 } },
  { "FUJIFILM", "FinePix X100", "5900K", 0,	{ 1.5927, 1, 1.2318, 0 } },
  { "FUJIFILM", "FinePix X100", "6300K", 0,	{ 1.6457, 1, 1.1887, 0 } },
  { "FUJIFILM", "FinePix X100", "6700K", 0,	{ 1.6921, 1, 1.1556, 0 } },
  { "FUJIFILM", "FinePix X100", "7100K", 0,	{ 1.7318, 1, 1.1291, 0 } },
  { "FUJIFILM", "FinePix X100", "7700K", 0,	{ 1.7881, 1, 1.0960, 0 } },
  { "FUJIFILM", "FinePix X100", "8300K", 0,	{ 1.8377, 1, 1.0728, 0 } },
  { "FUJIFILM", "FinePix X100", "9100K", 0,	{ 1.8940, 1, 1.0464, 0 } },
  { "FUJIFILM", "FinePix X100", "10000K", 0,	{ 1.9503, 1, 1.0298, 0 } },
...
// Fin ajout
  ...
  /* -7/+7 fine tuning is -7/+7 in both amber-blue and green-magenta */
  { "OLYMPUS", "E-P3", Daylight, -7,		{ 2.0000, 1, 1.9297, 0 } },
  { "OLYMPUS", "E-P3", Daylight, 0,		{ 2.0469, 1, 1.4922, 0 } },
  { "OLYMPUS", "E-P3", Daylight, 7,		{ 2.0000, 1, 1.1016, 0 } },
  { "OLYMPUS", "E-P3", Shade, -7,		{ 2.3828, 1, 1.5391, 0 } },
  { "OLYMPUS", "E-P3", Shade, 0,		{ 2.4375, 1, 1.1875, 0 } },
  { "OLYMPUS", "E-P3", Shade, 7,		{ 2.7477, 1.1532, 1, 0 } },
  { "OLYMPUS", "E-P3", Cloudy, -7,		{ 2.1719, 1, 1.7812, 0 } },
  { "OLYMPUS", "E-P3", Cloudy, 0,		{ 2.2188, 1, 1.3750, 0 } },
  { "OLYMPUS", "E-P3", Cloudy, 7,		{ 2.1641, 1, 1.0078, 0 } },
  { "OLYMPUS", "E-P3", Incandescent, -7,	{ 1.1953, 1, 3.2812, 0 } },
  { "OLYMPUS", "E-P3", Incandescent, 0,		{ 1.2266, 1, 2.5312, 0 } },
  { "OLYMPUS", "E-P3", Incandescent, 7,		{ 1.1953, 1, 1.8672, 0 } },
  { "OLYMPUS", "E-P3", Fluorescent, -7,		{ 1.9297, 1, 2.5625, 0 } },
  { "OLYMPUS", "E-P3", Fluorescent, 0,		{ 1.9766, 1, 1.9766, 0 } },
  { "OLYMPUS", "E-P3", Fluorescent, 7,		{ 1.9297, 1, 1.4531, 0 } },
  { "OLYMPUS", "E-P3", Flash, -7,		{ 2.1641, 1, 1.7656, 0 } },
  ...
  { "OLYMPUS", "E-PL1", Daylight, 7,		{ 1.706349, 1.015873, 1, 0 } },
  { "OLYMPUS", "E-PL1", Shade, -7,		{ 2.039063, 1, 1.343750, 0 } },
  { "OLYMPUS", "E-PL1", Shade, 0,		{ 2.085937, 1, 1.039062, 0 } },
  { "OLYMPUS", "E-PL1", Shade, 7,		{ 2.663265, 1.306122, 1, 0 } },
  { "OLYMPUS", "E-PL1", Cloudy, -7,		{ 1.859375, 1, 1.562500, 0 } },
  { "OLYMPUS", "E-PL1", Cloudy, 0,		{ 1.906250, 1, 1.210938, 0 } },
  { "OLYMPUS", "E-PL1", Cloudy, 7,		{ 2.096491, 1.122807, 1, 0 } },
  { "OLYMPUS", "E-PL1", Incandescent, -7,	{ 1, 1.040650, 3.479675, 0 } },
  { "OLYMPUS", "E-PL1", Incandescent, 0,	{ 1, 1.015873, 2.619048, 0 } },
  { "OLYMPUS", "E-PL1", Incandescent, 7,	{ 1, 1.049180, 1.991803, 0 } },
  { "OLYMPUS", "E-PL1", WhiteFluorescent, -7,	{ 1.609375, 1, 2.546875, 0 } },
  { "OLYMPUS", "E-PL1", WhiteFluorescent, 0,	{ 1.648437, 1, 1.960937, 0 } },
  { "OLYMPUS", "E-PL1", WhiteFluorescent, 7,	{ 1.609375, 1, 1.437500, 0 } },
  { "OLYMPUS", "E-PL1", NeutralFluorescent, -7,	{ 1.570312, 1, 2.210937, 0 } },
  { "OLYMPUS", "E-PL1", NeutralFluorescent, 0,	{ 1.609375, 1, 1.710938, 0 } },
  { "OLYMPUS", "E-PL1", NeutralFluorescent, 7,	{ 1.570313, 1, 1.257813, 0 } },
  { "OLYMPUS", "E-PL1", DaylightFluorescent, -7, { 1.960937, 1, 1.718750, 0 } },
  { "OLYMPUS", "E-PL1", DaylightFluorescent, 0,	{ 2.015625, 1, 1.328125, 0 } },
  { "OLYMPUS", "E-PL1", DaylightFluorescent, 7,	{ 2.016000, 1.024000, 1, 0 } },
  { "OLYMPUS", "E-PL1", Flash, -7,		{ 1.851563, 1, 1.554688, 0 } },
  { "OLYMPUS", "E-PL1", Flash, 0,		{ 1.898438, 1, 1.203125, 0 } },
  { "OLYMPUS", "E-PL1", Flash, 7,		{ 2.106195, 1.132743, 1, 0 } },
  ...
  /* Firmware version 1.3 */
  /* -7/+7 fine tuning is -7/+7 in both amber-blue and green-magenta */
  { "OLYMPUS", "E-PL3", Daylight, -7,		{ 1.929687, 1, 1.882812, 0 } },
  { "OLYMPUS", "E-PL3", Daylight, 0,		{ 1.976562, 1, 1.453125, 0 } },
  { "OLYMPUS", "E-PL3", Daylight, 7,		{ 1.929687, 1, 1.062500, 0 } },
  { "OLYMPUS", "E-PL3", Shade, -7,		{ 2.328125, 1, 1.492187, 0 } },
  { "OLYMPUS", "E-PL3", Shade, 0,		{ 2.382812, 1, 1.156250, 0 } },
  { "OLYMPUS", "E-PL3", Shade, 7,		{ 2.733945, 1.174312, 1, 0 } },
  { "OLYMPUS", "E-PL3", Cloudy, -7,		{ 2.117187, 1, 1.726563, 0 } },
  { "OLYMPUS", "E-PL3", Cloudy, 0,		{ 2.164063, 1, 1.335938, 0 } },
  { "OLYMPUS", "E-PL3", Cloudy, 7,		{ 2.142857, 1.015873, 1, 0 } },
  { "OLYMPUS", "E-PL3", Tungsten, -7,		{ 1.148437, 1, 3.203125, 0 } },
  { "OLYMPUS", "E-PL3", Tungsten, 0,		{ 1.171875, 1, 2.468750, 0 } },
  { "OLYMPUS", "E-PL3", Tungsten, 7,		{ 1.148437, 1, 1.820313, 0 } },
  { "OLYMPUS", "E-PL3", Fluorescent, -7,	{ 1.914063, 1, 2.507813, 0 } },
  { "OLYMPUS", "E-PL3", Fluorescent, 0,		{ 1.953125, 1, 1.937500, 0 } },
  { "OLYMPUS", "E-PL3", Fluorescent, 7,		{ 1.914063, 1, 1.429688, 0 } },
  { "OLYMPUS", "E-PL3", Underwater, -7,		{ 2.335938, 1, 1.921875, 0 } },
  { "OLYMPUS", "E-PL3", Underwater, 0,		{ 2.390625, 1, 1.484375, 0 } },
  { "OLYMPUS", "E-PL3", Underwater, 7,		{ 2.335938, 1, 1.085938, 0 } },
  { "OLYMPUS", "E-PL3", Flash, -7,		{ 2.523438, 1, 1.617188, 0 } },
  { "OLYMPUS", "E-PL3", Flash, 0,		{ 2.585938, 1, 1.250000, 0 } },
  { "OLYMPUS", "E-PL3", Flash, 7,		{ 2.769231, 1.094017, 1, 0 } },
